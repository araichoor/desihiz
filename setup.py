...
#
setup_keywords['name'] = 'desihizmerge'
setup_keywords['description'] = 'DESI hi-z data merge'
setup_keywords['author'] = 'Anand Raichoor'
setup_keywords['author_email'] = 'araichoor@lbl.gov' 
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/araichoor/desihizmerge'
#
